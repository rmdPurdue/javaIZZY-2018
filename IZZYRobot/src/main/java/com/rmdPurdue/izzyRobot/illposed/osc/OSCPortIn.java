...
package com.rmdPurdue.izzyRobot.illposed.osc;

import com.rmdPurdue.izzyRobot.illposed.osc.utility.OSCByteArrayToJavaConverter;
import com.rmdPurdue.izzyRobot.illposed.osc.utility.OSCPacketDispatcher;
import com.rmdPurdue.izzyRobot.illposed.osc.utility.OSCPatternAddressSelector;
 ...
 *
 * An example:<br>
 * (loosely based on {com.rmdPurdue.izzyRobot.illposed.osc.OSCPortTest#testReceiving()})
 * <blockquote><pre>{@code
...
public class OSCPortIn extends OSCPort implements Runnable {
	private static final Logger log = LogManager.getLogger(OSCPortIn.class);
	...
	public void run() {
		...
		try {
			...
			ex.printStackTrace(); // XXX This may not be a good idea, as this could easily lead to a never ending series of exceptions thrown (due to the non-exited while loop), and because the user of the lib may want to handle this case by themselves
		}
	}
