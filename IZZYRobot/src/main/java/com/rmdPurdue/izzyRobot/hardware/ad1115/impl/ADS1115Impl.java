package com.rmdPurdue.izzyRobot.hardware.ad1115.impl;
...
public class ADS1115Impl implements ADS1115 {
    ...
    private static final Logger log = LogManager.getLogger(ADS1115Impl.class);

    public static final int ADDRESS = 0x49;
    ...
    public ADS1115Impl(Context pi4j, int address, GAIN gain, int i2cBus) {
        ...
        log.debug("IC2: " + i2cConfig.getDescription().toString());
