...
import com.rmdPurdue.izzyRobot.motherCommunication.IZZYOSCReceiver;
...
import static com.rmdPurdue.izzyRobot.motherCommunication.lineFollowing.OSCAddresses.*;

public class IZZYOSCReceiverLineFollow extends IZZYOSCReceiver {
    private static final Logger log = LogManager.getLogger(IZZYOSCReceiverLineFollow.class);
